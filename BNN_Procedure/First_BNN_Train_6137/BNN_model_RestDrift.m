...
X_val = X_val_std;      
X_test = X_test_std;    
Y_train = log(Y_train_orig(:, 3)); 
Y_val = log(Y_val_orig(:, 3));     
Y_test = Y_test_orig(:, 3);        
...
%% 6. 保存模型和训练状态
save('BNN_model_ResDrift_orig_6137_random.mat', 'bestNet', 'samplingNoise','trailingAvg','trailingAvgSq',...
...
load('BNN_model_ResDrift_orig_6137_random.mat');
